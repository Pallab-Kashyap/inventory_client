...
const ItemLibrary = () => {
  ...
  const items = [
    {
      ...
      variations: [
        { id: "101", name: "S, Red", stock: 10, price: 499, image: [
          "https://images.unsplash.com/photo-1537204696486-967f1b7198c8"
        ] },
        { id: "102", name: "M, Blue", stock: 20, price: 499, image: [
          "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab"
        ] },
        { id: "103", name: "L, Black", stock: 20, price: 499, image: [
    ...
    },
    {
      ...
      variations: [
        { id: "104", name: "42, Black", stock: 10, price: 1999, image: [
          "https://images.unsplash.com/photo-1533222481259-91b1f1502b28"
        ] },
        { id: "105", name: "40, White", stock: 10, price: 1999, image: [
          "https://images.unsplash.com/photo-1560072810-1c60179426d3"
        ] },
        { id: "106", name: "41, Red", stock: 10, price: 1999, image: [
    ...
    },
    {
      ...
      variations: [
        { id: "107", name: "Medium, Grey", stock: 10, price: 1499, image: [
          "https://images.unsplash.com/photo-1599940832517-9b4b9d6b5833"
        ] },
        { id: "108", name: "Large, Black", stock: 10, price: 1599, image: [
  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      <div id="products" className="w-full flex-1 overflow-hidden">
        <div
          id="hedders"
